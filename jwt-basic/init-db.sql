...
SELECT 'CREATE DATABASE jwt-basic-demo-db'
    WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'jwt-basic-demo-db')\gexec
...
-- Grant privileges
GRANT ALL PRIVILEGES ON DATABASE jwt-basic-demo-db TO jwtuser;
...
\echo 'Database jwt-basic-demo-db initialized successfully!'
